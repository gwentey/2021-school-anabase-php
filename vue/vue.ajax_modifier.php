<?php foreach ($c->data["leCongressisteSelectionne"] as $key) { ?>
    ...
    <div class="container" style="margin-top: 1em;">
        <!-- Sign up form -->
        <form>
            <input type="hidden" id="NUM_CONGRESSISTE" name="NUM_CONGRESSISTE" value="<?= $key->NUM_CONGRESSISTE ?>"/>
            <!-- Sign up card -->
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="form-group col-md-2">
                            ...
                            <option value="<?= $key->SEXE_CONGRESSISTE ?>"><?= $key->SEXE_CONGRESSISTE ?></option>
                                <?php if($key->SEXE_CONGRESSISTE == "Mme."){ ?>
                        ...
                        <div class="form-group col-md-5">
                            <input id="first_name" type="text" class="form-control" name="PRENOM_CONGRESSISTE" placeholder="Prénom" value="<?= $key->PRENOM_CONGRESSISTE ?>">
                            <div id="first_name_feedback" class="invalid-feedback">

                            </div>
                        </div>
                        <div class="form-group col-md-5">
                            <input id="last_name" type="text" class="form-control" name="NOM_CONGRESSISTE" placeholder="Nom" value="<?= $key->NOM_CONGRESSISTE ?>">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="adresse" class="form-control" id="adresse" name="ADRESSE_CONGRESSISTE" value="<?= $key->ADRESSE_CONGRESSISTE ?>" placeholder="3 rue ...." required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="tel" name="TEL_CONGRESSISTE" value="<?= $key->TEL_CONGRESSISTE ?>" placeholder="+33 6 99 99 99 99" required>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="NUM_ORGANISME" id="NUM_ORGANISME" class="form-control">
                                    <option data-id="<?= $key->NOM_ORGANISME ?>" value="<?= $key->NUM_ORGANISME ?>"><?= $key->NOM_ORGANISME ?></option>
                            ...
                            <select name="NOM_HOTEL" id="NUM_HOTEL" class="form-control">
                                <option data-id="<?= $key->NOM_HOTEL ?>" value="<?= $key->NUM_HOTEL ?>"><?= $key->NOM_HOTEL ?></option>
                                ...
                                <input type="text" name="CODE_ACCOMPAGNATEUR" class="form-control" id="CODE_ACCOMPAGNATEUR" placeholder="Code accompagnateur" value="<?= $key->CODE_ACCOMPAGNATEUR ?>" required>
