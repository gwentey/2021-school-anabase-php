                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12 col-xl-12">
                            <form action="./?action=inscription" metheod="POST">
                                    <input width="40" height="40" type="image" alt="Ajouter" src="./images/retour.png">
                            </form>        
                                <br /><br />
...
<div class="container" style="margin-top: 1em;">
    <!-- Sign up form -->
    <form action="./?controleur=inscription&todo=enregistrer" method="POST">
        <!-- Sign up card -->
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="form-group col-md-2">
                        <select name="SEXE_CONGRESSISTE" id="input_sex" class="form-control">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <select name="NUM_HOTEL" id="NUM_HOTEL" class="form-control">
